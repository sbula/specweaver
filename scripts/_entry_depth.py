...
#: Not ours to wrap.
_SKIP_DIRS = frozenset({".venv", "node_modules", ".git", "__pycache__", "site-packages", ".tmp"})
#: `.tmp` is gitignored session scratch, regenerated by the nightly; a registry gate that
#: judges it can go red overnight with nothing committed, which is a false alarm by shape.
