...
| **3.14a** 🚧 | AST Drift Detection & AI Root-Cause Analysis | _(deferred from 3.14)_ | Builds on 3.14 UUIDs to provide deep, parser-backed drift detection. **In progress**: SF-1 (AST Engine & validation rules) complete. Total tests: 3671. Pending SF-2 (Flow Integration). See [planning](phase_3/feature_3_14a_design.md). |
