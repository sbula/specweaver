...
| **3.14a** ✅ | AST Drift Detection & AI Root-Cause Analysis | _(deferred from 3.14)_ | Builds on 3.14 UUIDs to provide deep, parser-backed drift detection. **Complete**: SF-1 and SF-2 integrated into Flow engine and CLI. Tests passing. See [planning](phase_3/feature_3_14a_design.md). |
