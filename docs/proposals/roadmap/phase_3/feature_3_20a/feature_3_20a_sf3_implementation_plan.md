...
- **Implementation Plan**: docs/proposals/roadmap/phase_3/feature_3_20a/feature_3_20a_sf3_implementation_plan.md
- **Status**: APPROVED
...
#### [MODIFY] `tach.toml`
- Declare `src.specweaver.api` and `src.specweaver.cli` as tracked modules.
...
- I will prune lines 78-95 which contain legacy backward-compatible re-exports (`from specweaver.cli._helpers import...`) since this violates Python clean architecture when `tach` defines the interface bounds. 
