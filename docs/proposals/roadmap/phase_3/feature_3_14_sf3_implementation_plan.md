...
- **Implementation Plan**: docs/proposals/roadmap/phase_3/feature_3_14_sf3_implementation_plan.md
- **Status**: APPROVED
...
- Import `SCHEMA_V12` from `specweaver.config._schema`.
...
- Import `from specweaver.cli import lineage`.
...
- If `lineage` is true:
    ...
    - Call `specweaver.cli.lineage.check_lineage(target/project_dir)`.
