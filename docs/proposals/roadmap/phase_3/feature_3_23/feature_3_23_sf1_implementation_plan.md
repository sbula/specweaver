...
- **Implementation Plan**: docs/proposals/roadmap/phase_3/feature_3_23/feature_3_23_sf1_implementation_plan.md
- **Status**: APPROVED
...
> The generated bash script must execute: `"$PYTHON_EXEC" -m specweaver.cli.main drift check-rot --staged`.
