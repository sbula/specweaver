...
> [!NOTE]
> **Detailed phase roadmaps** are in [`docs/roadmap/`](roadmap/). This document is the high-level overview only.
...
- ✅ Feature 3.22: Polyglot AST Skeleton Extractor — High-performance tree-sitter bindings for `read_skeleton`, `replace_symbol`, etc. across Python, Java, Kotlin, Rust, TS, and Markdown.
