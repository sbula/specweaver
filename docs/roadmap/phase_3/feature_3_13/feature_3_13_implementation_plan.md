...
def _discover_adapters() -> None:
    ...
    """
    from specweaver.infrastructure.llm.adapters.base import LLMAdapter as BaseClass
...
def load_settings(db, project_name, *, llm_role="review"):
    ...
    from specweaver.infrastructure.llm.adapters import ADAPTER_REGISTRY
