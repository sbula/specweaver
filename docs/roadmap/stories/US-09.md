...
* **Speed & Security (Rust):** ⚰️ **Descoped 2026-08-20.**

  > The 2026-08-13 `ADR-003` step had moved this scope to `A-EXEC-03`. The 2026-08-20
  > [benefit review](../../analysis/benefit_chain_analysis_2026-08-20.md) then judged that capability a dead end — no measured wait on the bouncer or extractor
  > was ever recorded — and descoped the work with it. Terminal: no successor owns this scope, deliberately.
