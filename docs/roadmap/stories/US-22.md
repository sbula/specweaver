...
* **Verifiable Proof:** P-2 by
  ...
  unit-proven; the join to validation is missing, which is a defect in delivered work and needs its
  own ticket rather than a test written around it. Both also by `check_fr_coverage.py A-VAL-01` and
