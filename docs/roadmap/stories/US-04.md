# US-04: Context-Aware Flow Orchestration
...
* **Status:** ✅ Complete (2026-08-15) — persistence delivered by `SF-01` across four commit
  ...
  decision — and *sanitized* mapped to `E-VAL-03`, retired 2026-08-21 (benefit review §8), so that
  clause is now unsatisfiable **by decision**. See the proof matrix's `C1`/`C2`.
...
* **Declarative Dynamic Prompt Routing:** *Pending Design (minted 2026-07-24
...
* **Envelope-vs-Content Prompt Externalization:** *Pending Design (minted
...
* **Advanced Routing & Conditional Flows:** the add-on's contract under
`ADR-004`.
