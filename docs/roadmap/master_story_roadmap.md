...
> done: **9 of 45 TECH tickets are open**, and only one still asserts a claim against a candidate
...
*Open debt only — **9 of 45 tickets**. A delivered ticket leaves this section; the permanent
