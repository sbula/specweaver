...
*   **Core Required (MVS):**
    *   `[ ]` **INT-US-01:** Base Integration Contract defined in [US-01_integration.md](topics/topic_08_integration/US-01_integration.md)
...
*   **Sub-Story Add-Ons:**
    *   🔴 **Security Defenses:**
        *   `[ ]` **INT-US-01-SUB:** Sub-Story Integration (Pending Design)
...
*   **Sub-Story Add-Ons:**
    *   🔴 **Surgical Spec Refactoring:**
        *   `[ ]` **INT-US-02-SUB:** Sub-Story Integration (Pending Design)
...
*   **Sub-Story Add-Ons:**
    *   🔴 **Multi-Language Test Support:**
        *   `[ ]` **INT-US-03-SUB:** Sub-Story Integration (Pending Design)
...
*   **Sub-Story Add-Ons:**
    ...
    *   🔴 **Infinite Memory Management:**
        *   `[ ]` **INT-US-04-SUB:** Sub-Story Integration defined in [SF-6: Infinite Memory Management](features/topic_08_integration/INT-US-04/INT-US-04_design.md#sf-6-infinite-memory-management-integration-pending-design)
...
*   **Core Required (MVS):**
    *   `[ ]` **INT-US-05:** Base Integration Contract defined in [US-05_integration.md](topics/topic_08_integration/US-05_integration.md)
...
*   **Sub-Story Add-Ons:**
    *   🔴 **Strict UI Data Contracts:**
        *   `[ ]` **INT-US-06-SUB:** Sub-Story Integration (Pending Design)
...
*   **Sub-Story Add-Ons:**
    *   🔴 **Strict UI Data Contracts:**
        *   `[ ]` **INT-US-07-SUB:** Sub-Story Integration (Pending Design)
        *   `[ ]` **D-UI-02:** Structured output schemas
...
*   **Sub-Story Add-Ons:**
    *   🔴 **Socratic Context Gathering:**
        *   `[ ]` **INT-US-08-SUB:** Sub-Story Integration (Pending Design)
...
*   **Sub-Story Add-Ons:**
    *   🟡 **Containerized Isolation:**
        *   `[ ]` **INT-US-09-SUB:** Sub-Story Integration (Pending Design)
...
*   **Sub-Story Add-Ons:**
    *   🔴 **Code-to-Spec Drift Checking:**
        *   `[ ]` **INT-US-10-SUB:** Sub-Story Integration (Pending Design)
...
*   **Sub-Story Add-Ons:**
    *   🔴 **Dynamic Knowledge Relevance:**
        *   `[ ]` **INT-US-11-SUB:** Sub-Story Integration (Pending Design)
...
*   **Sub-Story Add-Ons:**
    *   🔴 **Massive Scale Context Retrieval:**
        *   `[ ]` **INT-US-12-SUB:** Sub-Story Integration (Pending Design)
        *   `[ ]` **A-SENS-02:** Postgres (Apache AGE + pgvector) sidecar
...
*   **Sub-Story Add-Ons:**
    *   🔴 **Symbolic Tree Traversal:**
        *   `[ ]` **INT-US-13-SUB:** Sub-Story Integration (Pending Design)
...
*   **Sub-Story Add-Ons:**
    *   🔴 **Mathematical Mutation Checks:**
        *   `[ ]` **INT-US-14-SUB:** Sub-Story Integration (Pending Design)
...
*   **Sub-Story Add-Ons:**
    *   🔴 **Enterprise Compliance Protocols:**
        *   `[ ]` **INT-US-15-SUB:** Sub-Story Integration (Pending Design)
...
*   **Sub-Story Add-Ons:**
    *   🔴 **Dynamic Data-Driven Routing:**
        *   `[ ]` **INT-US-16-SUB:** Sub-Story Integration (Pending Design)
...
*   **Sub-Story Add-Ons:**
    *   🔴 **Continuous Integration:**
        *   `[ ]` **INT-US-17-SUB:** Sub-Story Integration (Pending Design)
...
*   **Sub-Story Add-Ons:**
    *   🔴 **Secure Sandboxed Operations:**
        *   `[ ]` **INT-US-18-SUB:** Sub-Story Integration (Pending Design)
        *   `[ ]` **D-INTL-04:** Interactive Design Questionnaire
...
*   **Sub-Story Add-Ons:**
    *   🔴 **Cross-Service Contract Validation:**
        *   `[ ]` **INT-US-19-SUB:** Sub-Story Integration (Pending Design)
...
*   **Sub-Story Add-Ons:**
    *   🔴 **Test Intensity Gating:**
        *   `[ ]` **INT-US-20-SUB:** Sub-Story Integration (Pending Design)
...
*   **Sub-Story Add-Ons:**
    *   🔴 **Mathematical Speed & Security:**
        *   `[ ]` **INT-US-22-SUB:** Sub-Story Integration (Pending Design)
...
*   **Sub-Story Add-Ons:**
    *   🔴 **Strict Security Gating:**
        *   `[ ]` **INT-US-23-SUB:** Sub-Story Integration (Pending Design)
...
*   **Sub-Story Add-Ons:**
    *   🔴 **Dynamic Risk Controls:**
        *   `[ ]` **INT-US-25-SUB:** Sub-Story Integration (Pending Design)
...
*   **Sub-Story Add-Ons:**
    *   🔴 **Massive Scale Orchestration:**
        *   `[ ]` **INT-US-26-SUB:** Sub-Story Integration (Pending Design)
...
*   **Core Required (MVS):**
    ...
    *   `[/]` **B-INTL-09:** Agent Memory Bank (Schema + CRUD + Resilience) — [Design](features/topic_04_intelligence/B-INTL-09/B-INTL-09_design.md) (SF-1 Complete)
