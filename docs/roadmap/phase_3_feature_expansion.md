...
| **3.32e** | Polyglot Expansion | _(new)_ | Increase Tree-Sitter grammar bindings from 5 to 25 languages. High-ROI expansion of 3.22 to maximize language coverage before committing graph clusters. |
