...
| **3.32e** | Polyglot Expansion | _(new)_ | High-ROI expansion of Tree-sitter grammars (expanding beyond the 3.22 baseline). Explicitly drops vanity-metric expansion in favor of targeted enterprise value: **Markdown** (absolute priority for parsing Spec.md structurally into the graph), **YAML/JSON** (mapping configs), Rust, C#, and SQL. |
