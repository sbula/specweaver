...
* **`E-VAL-03` ⚰️ RETIRED:** *(AST Prompt Injection Sanitization — retired 2026-08-21 by the user, ruled nonsense under the
  [benefit review](../../analysis/benefit_chain_analysis_2026-08-20.md) §8: it filtered attacks the sandbox already survives and missed semantic poisoning;
  best-effort, so nothing could rely on it. Detector code deleted; `escaping.py` stays under `E-INTL-01`; the structure-into-prompts successor is `B-SENS-09`.
