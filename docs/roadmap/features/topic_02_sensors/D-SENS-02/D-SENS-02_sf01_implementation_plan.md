# Implementation Plan: Polyglot AST Skeleton Extractor [SF-01]
- **Feature ID**: 3.22
- **Sub-Feature**: SF-01 — Polyglot AST Extractor
- **Design Document**: docs/roadmap/features/topic_02_sensors/D-SENS-02/D-SENS-02_design.md
- **Implementation Plan**: docs/roadmap/features/topic_02_sensors/D-SENS-02/D-SENS-02_sf01_implementation_plan.md
- **Status**: COMPLETE
...
> Do not attempt to implement `write_symbol` in this plan. Safely patching AST nodes requires significantly higher complexity and is explicitly scoped out of SF-01 to prevent scope creep.
