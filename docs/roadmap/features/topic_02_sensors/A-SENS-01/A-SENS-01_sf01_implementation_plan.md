# Implementation Plan: Deep Semantic Hashing [SF-01: Polyglot Parser Decoupling]
- **Feature ID**: 3.32
- **Sub-Feature**: SF-01 — Polyglot Parser Decoupling
...
- **Implementation Plan**: docs/roadmap/features/topic_02_sensors/A-SENS-01/A-SENS-01_sf01_implementation_plan.md
- **Status**: APPROVED
...
#### [NEW] `src/specweaver/workspace/ast/parsers/context.yaml`
...
- **Action**: Add `specweaver/workspace/ast/parsers` to `consumes`.
...
- **Action**: Update imports to point to `specweaver.workspace.ast.parsers.interfaces`.
