...
> [!NOTE]
> **Lineage Deferment:** The migration of `artifact_events` from the global DB, and the updating of the `sw lineage` CLI, have been explicitly deferred to **SF-03** to prevent breaking the `main` test suite at this commit boundary.
