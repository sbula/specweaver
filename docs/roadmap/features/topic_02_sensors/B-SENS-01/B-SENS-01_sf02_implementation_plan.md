# Implementation Plan: Feature 3.14 [SF-02: Artifact Tagging Engine]
- **Feature ID**: 3.14
- **Sub-Feature**: SF-02 — Artifact Tagging Engine
...
- **Function**: `add_artifact_tagging(artifact_id: str, language: str) -> PromptBuilder`
  - Import `wrap_artifact_tag` from `specweaver.core.loom.commons`.
...
2. **Architecture**:
   - `sw check --lineage` (in SF-03) will confirm these tags.
