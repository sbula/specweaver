...
- **TECH-009**: Narrow `except Exception` in Java/Kotlin runners to specific exception types.
- **TECH-008**: (existing) Migrate `git/core/executor.py` and `filesystem/core/search.py` to `SubprocessExecutor`.
