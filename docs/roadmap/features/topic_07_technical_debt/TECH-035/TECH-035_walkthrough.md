...
> Moved here from `TECH-035_design.md` on 2026-08-13 under `TECH-044`. Nothing was rewritten in the
> move — these sections are reproduced as they stood. They are dated delivery narrative: what was
> built, which probes were wrong, what remains. The design keeps the problem, the evidence for it,
> the approaches and the non-goals.
