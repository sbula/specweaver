...
The goal of TECH-07 is to execute a **Non-Destructive Copy-and-Verify** refactoring of `docs/architecture` into a modular, visually-rich, GitHub-publishable reference site aligned perfectly with DDD principles (Hexagonal Layers, Bounded Contexts).
...
- **Impl Plan**: `docs/roadmap/features/topic_07_technical_debt/TECH-07/TECH-07_sf01_implementation_plan.md`
...
- **Impl Plan**: `docs/roadmap/features/topic_07_technical_debt/TECH-07/TECH-07_sf02_implementation_plan.md`
...
- **Impl Plan**: `docs/roadmap/features/topic_07_technical_debt/TECH-07/TECH-07_sf03_implementation_plan.md`
