...
- **End-to-End Environment**: We will rely on existing E2E infrastructure (`test_hooks_e2e.py`) created in SF-01 to assert OS-level `exit 1` blockades, eliminating the need for a secondary E2E layer for SF-02.
