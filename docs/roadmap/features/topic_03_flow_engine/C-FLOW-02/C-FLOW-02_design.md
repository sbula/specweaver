...
- **Phase**: 3
- **Status**: APPROVED
- **Design Doc**: docs/roadmap/features/topic_03_flow_engine/C-FLOW-02/C-FLOW-02_design.md
...
- **Depends on**: none
- **Impl Plan**: docs/roadmap/features/topic_03_flow_engine/C-FLOW-02/C-FLOW-02_implementation_plan.md
