...
workspace_cli.add_typer(constitution_app, name="constitution")

from specweaver.workspace.project.interfaces.cli_hooks import hooks_app  # noqa: E402

workspace_cli.add_typer(hooks_app, name="hooks")
