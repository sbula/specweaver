...
"""Tool definitions — provider-agnostic ToolDefinition instances.

Each adapter converts these to its provider's format. The definitions
describe the tools' parameters using SpecWeaver's own ToolParameter model.
"""
...
# ---------------------------------------------------------------------------
# File system tools (implemented in loom/tools/filesystem + loom/commons/filesystem/search)
# ---------------------------------------------------------------------------
...
# ---------------------------------------------------------------------------
# Web tools (implemented in loom/tools/web)
# ---------------------------------------------------------------------------
...
FILE_TOOLS = [GREP, FIND_FILES, READ_FILE, LIST_DIRECTORY]
