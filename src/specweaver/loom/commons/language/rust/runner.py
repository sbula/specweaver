...
from specweaver.loom.commons.language.rust.parsers import parse_clippy_complexity
...
class RustRunner(QARunnerInterface):
    ...
    def run_linter(self, target: str, fix: bool = False) -> LintRunResult:
        ...
        from specweaver.loom.commons.qa_runner.interface import LintError, LintRunResult
