...
"""Tests for specweaver.workspace.project.constitution — TDD (tests first)."""
...
class TestBuildTechStackRows:
    ...
    def test_empty_languages_returns_todo_row(self) -> None:
        ...
        from specweaver.workspace.project.constitution import _build_tech_stack_rows
...
class TestBuildStandardsSection:
    ...
    def test_string_data_parsed_as_json(self) -> None:
        ...
        from specweaver.workspace.project.constitution import _build_standards_section
