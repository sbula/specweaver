...
from specweaver.infrastructure.llm.adapters.registry import (
    _ensure_discovered,
    get_adapter_class,
    get_all_adapters,
...
def test_ensure_discovered_implicit_namespace_package():
    """
    Integration/Edge Case: Proves `specweaver.infrastructure.llm.adapters` natively functions as a PEP 420
    ...
    """
    import specweaver.infrastructure.llm.adapters as adapters_package
