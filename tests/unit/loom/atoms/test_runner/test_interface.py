...
class TestInterfaceContract:
    """Tests that TestRunnerInterface is an ABC and cannot be instantiated."""

    def test_cannot_instantiate_abc(self) -> None:
        with pytest.raises(TypeError):
            TestRunnerInterface()  # type: ignore[abstract]

    def test_python_runner_is_instance(self, tmp_path: Path) -> None:
        runner = PythonTestRunner(cwd=tmp_path)
        assert isinstance(runner, TestRunnerInterface)


# ---------------------------------------------------------------------------
# PythonTestRunner — run_tests
# ---------------------------------------------------------------------------


class TestPythonTestRunnerTests:
    """Tests for PythonTestRunner.run_tests via subprocess mocking."""
...
# ---------------------------------------------------------------------------
# PythonTestRunner — run_linter
# ---------------------------------------------------------------------------


class TestPythonTestRunnerLinter:
    """Tests for PythonTestRunner.run_linter via subprocess mocking."""
...
# ---------------------------------------------------------------------------
# PythonTestRunner — run_complexity
# ---------------------------------------------------------------------------


class TestPythonTestRunnerComplexity:
    """Tests for PythonTestRunner.run_complexity via subprocess mocking."""
