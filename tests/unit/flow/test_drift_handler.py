...
from specweaver.flow._drift import DriftCheckHandler, _load_plan
from specweaver.flow.runner import RunContext
...
async def test_drift_handler_analyze_drift_logic(tmp_path: Path) -> None:
    ...
    from specweaver.flow.runner import RunContext
    from specweaver.validation.models import DriftFinding, DriftReport, Severity
