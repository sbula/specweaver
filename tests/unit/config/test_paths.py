...
"""Tests for specweaver.config.paths — centralized data path resolution."""
...
class TestSpecweaverRoot:
    ...
    def test_default_is_home_dot_specweaver(self, monkeypatch: pytest.MonkeyPatch) -> None:
        ...
        from specweaver.config.paths import specweaver_root
...
class TestPathConsistency:
    ...
    def test_all_paths_share_root(self, monkeypatch: pytest.MonkeyPatch, tmp_path: Path) -> None:
        ...
        from specweaver.config.paths import config_db_path, logs_dir, specweaver_root, state_db_path
