...
from specweaver.assurance.standards.recency import compute_half_life, recency_weight
...
class TestFindOldestSourceMtime:
    ...
    def test_no_source_files_returns_none(self, tmp_path: Path) -> None:
        ...
        from specweaver.assurance.standards.recency import _find_oldest_source_mtime
