...
"""Tests for specweaver.core.config.profiles — YAML-backed domain profiles.
...
from specweaver.core.config.profiles import (
    DomainProfile,
    get_profile,
    list_profiles,
    profile_exists,
...
class TestExtractDescription:
    ...
    def test_missing_description_field_returns_empty(self, tmp_path) -> None:
        ...
        from specweaver.core.config.profiles import _extract_description
