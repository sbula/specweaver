...
class TestPythonContractRenderer:
    def test_renders_protocol_class(self) -> None:
        from specweaver.core.flow.handlers.contract_renderers import render_python_protocol
...
class TestJavaContractRenderer:
    def test_renders_interface(self) -> None:
        from specweaver.core.flow.handlers.contract_renderers import render_java_interface
    ...
    def test_extension_is_java(self) -> None:
        from specweaver.core.flow.handlers.contract_renderers import contract_extension
...
class TestKotlinContractRenderer:
    def test_renders_interface(self) -> None:
        from specweaver.core.flow.handlers.contract_renderers import render_kotlin_interface
...
class TestTypeScriptContractRenderer:
    def test_renders_interface(self) -> None:
        from specweaver.core.flow.handlers.contract_renderers import render_typescript_interface
...
class TestRustContractRenderer:
    def test_renders_trait(self) -> None:
        from specweaver.core.flow.handlers.contract_renderers import render_rust_trait
...
class TestRenderContractDispatch:
    def test_python_dispatch(self) -> None:
        from specweaver.core.flow.handlers.contract_renderers import render_contract
