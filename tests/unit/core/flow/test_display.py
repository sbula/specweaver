...
from specweaver.core.flow.display import JsonPipelineDisplay, RichPipelineDisplay, _StepState
...
class TestJsonPipelineDisplay:
    ...
    def test_run_serialized(self) -> None:
        ...
        from specweaver.core.flow.state import PipelineRun, RunStatus, StepRecord
...
class TestCLIRunEdgeCases:
    ...
    def test_rich_display_missing_event_data_graceful_ignore(self) -> None:
        ...
        from specweaver.core.flow.state import PipelineRun, StepResult, StepStatus
